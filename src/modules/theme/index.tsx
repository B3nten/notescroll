...
export function ThemeProvider({ children }: any) {
    ...
    const [theme, setTheme] = useState<Theme>({
        ...
        background: 'url(/assets/backgrounds/background-1.avif);',
        containerBackground: '#d87162',
    })
        ...
        <div className='relative'>
            ...
            <div className={styles.container}>
                <div
                    ...
                    style={theme.name === 'default' ? parchment : {background: theme.containerBackground}}
                ></div>
...
const parchment = {
    filter: 'url(#wavy2)',
    background: '#fffef0',
    boxShadow: '0 0 100px #8f5922 inset',
